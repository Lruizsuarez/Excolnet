...
public class ProfileActivity extends AppCompatActivity {
    ...
    public void setUpHeaderColor() {
        ...
        Palette.from(bitmap).generate(palette -> {
            int vibrantColor = Objects.requireNonNull(palette).getVibrantColor(getResources().getColor(R.color.primary_500));
    ...
    public void setUpAppBarLayout() {
        profileHeader.addOnOffsetChangedListener((appBarLayout, verticalOffset) -> {
